      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {vehicles.map(v => (
          <div key={v._id} className="bg-white p-4 rounded shadow">
            <img src={v.image} alt={v.model} className="h-40 w-full object-cover rounded mb-2"/>
            ...
            <p><strong>Availability:</strong> {v.available ? "Available" : "Not available"}</p>
            <button className="bg-green-600 text-white px-3 py-1 rounded mt-2 hover:bg-green-700">
              Book
            </button>
          </div>
        ))}
